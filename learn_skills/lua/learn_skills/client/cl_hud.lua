...
hook.Add("HUDPaint", "HudLogique", function()
    ...
    if ply:Alive() && IsValid(ply) then
		...
		surface.DrawRect(hud:RespX(40), hud:RespY(1080-150), hud:RespX(372), hud:RespY(110))
        surface.SetDrawColor(81, 81, 81, 255)
		surface.DrawRect(hud:RespX(46), hud:RespY(1080-144), hud:RespX(360), hud:RespY(20))
