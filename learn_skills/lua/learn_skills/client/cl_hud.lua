...
hook.Add("HUDPaint", "HudLogique", function()
    ...
    if ply:Alive() && IsValid(ply) then
		...
		surface.DrawRect(hud:RespX(46), hud:RespY(1080-92), hud:RespX(260*level), hud:RespY(20))
        ...
        draw.SimpleTextOutlined((ply:getDarkRPVar("money") or "ERREUR") .. " ¥", "Simple_Hud_Font", hud:RespX(300), hud:RespY(1080-144), Color( 173, 173, 173, 255 ), TEXT_ALIGN_RIGHT, 0, 0, Color(0, 0, 0, 255))
        ...
        draw.SimpleTextOutlined( "Level : " .. ply:getDarkRPVar("level") .. " - " .. math.floor(level * 100) .. " %", "Simple_Hud_Font", hud:RespX(49), hud:RespY(1080-92), Color( 173, 173, 173, 255 ), TEXT_ALIGN_LEFT, 0, 0, Color(0, 0, 0, 255))
